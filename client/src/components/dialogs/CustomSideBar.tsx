...
const CustomSideBar: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-primary-blue">
      {/* Sidebar content */}
      <div className="flex flex-col items-center justify-between">
        <div className="my-5">
          <Link to="/" className="flex items-center gap-1 ml-1">
            ...
            <span className="font-bold text-white text-xl">BeHome's</span>
          </Link>
        </div>
      ...
      <div className="flex items-center justify-between p-8">
        <button
          className="select-none bg-primary-blue text-white py-2 rounded-3xl text-center font-bold hover:bg-blue-500 my-10 px-16 flex items-center w-auto"
          onClick={logout}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
