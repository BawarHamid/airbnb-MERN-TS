...
const OptionCard: React.FC<OptionCardProps> = ({ cardTitle, cardParagraf }) => {
  return (
    <button className="outline-none py-5 px-8 my-2 focus:border focus:border-blue-600 focus:bg-slate-50 rounded-lg shadow-lg shadow-[#E4E3E9] max-w-sm transform motion-safe:focus:scale-105">
