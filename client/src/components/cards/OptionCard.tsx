...
const OptionCard: React.FC<OptionCardProps> = ({ cardTitle, cardParagraf }) => {
  return (
    <button className="py-5 px-8 my-2 hover:bg-slate-50 focus:border-[2px] focus:border-blue-600 focus:bg-slate-50 rounded-lg shadow-lg shadow-[#E4E3E9] max-w-sm transform motion-safe:hover:scale-105">
