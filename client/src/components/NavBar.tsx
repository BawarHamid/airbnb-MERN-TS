    ...
    <>
      <header className="p-4 flex justify-between">
        <a href="" className="flex items-center gap-1 ml-1">
          ...
          <span className="font-bold text-xl">BeHome</span>
        </a>
        ...
        <div className="flex border items-center border-red-700 rounded-full py-2 px-4 gap-3 shadow-md shadow-red-200">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            style={svgStyleNavBarLogo}
